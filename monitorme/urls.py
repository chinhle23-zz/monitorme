...
urlpatterns = [
    ...
    # path('trackerinstance/create/<int:tracker_pk>', core_views.response_create, name="trackerinstance_create"),
    ...
    path('response/create/', core_views.answer_questions, name="response_create"),
